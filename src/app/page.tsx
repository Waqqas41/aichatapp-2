  ...
  return (
    <div className="min-h-screen bg-white bg-[url('/path/to/your/image.jpg')] bg-repeat">
      ...
      <div className="relative isolate">
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#8093ff] to-[#89fcca] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
            ...
            <div className="mx-auto max-w-md text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                ...
                <button
                  onClick={() => {
                    (
                      document.querySelector(".chatbot") as HTMLElement
                    )?.click(); // Simulate accordion click
                  }}
                  className="btn"
                >
                  Give it a try
